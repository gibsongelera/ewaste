					...
					$.ajax({
						...
						success:function(response) {
							...
							if(response.success == true) {
								...
								// create order button
								// Display success message with options to proceed to payment or add a new dispose
								...
								'</div>'); // Injects a success message into the DOM with options for payment or adding a new dispose

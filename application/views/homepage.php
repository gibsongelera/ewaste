						...
						<div class="col-md-4 col-sm-6">
							<div class="media small-teaser teaser inline-block">
								...
								<div class="media-body media-middle">
									...
									<br>
									<span class="small-text small-spacing lightgrey">ZPPSU, Zamboanga City, Philippines</span>
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
						...
						<div class="col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-0">
							<div class="media small-teaser teaser inline-block">
								...
								<div class="media-body media-middle">
									...
									<br>
									<span class="small-text small-spacing lightgrey">Weekdays 8:00am-5:00pm</span>
								</div>
							</div>
						</div>
					</div>

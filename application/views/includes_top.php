    ...
    <?php echo link_tag('components/assets/css/main.css'); ?>
    <?php echo link_tag('components/assets/css/datatables/datatable.css'); ?>
    <?php echo link_tag('components/assets/css/layout-fix.css'); ?>
    ...
    <?php 
        ...
        if($total_segments>=2){
            echo link_tag('components/assets/css/dashboard.css');
        }
    ?>

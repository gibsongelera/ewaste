...
<?php if($role=="admin"){ ?>
    ...
    //responsible for all delete functions
        ...
        //show approve modal
        function showApproveModal(approve_url)
        {
        ...
        <!-- (Approve Modal)--> 
          <div class="modal fade primary" id="approveModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content" style="margin-top:100px;">
                    <div class="modal-header" style=" background-color:#54be73;">
                        <button type="button" style="color:#fff;" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" style="text-align:center; font-weight:bold; color:#fff;">Approve this Dispose? This will mark as paid and collected!</h4>
                    </div>
                    <div class="modal-footer" style="margin:0px; border-top:0px; text-align:center;">
                        <a href="#" class="btn btn-danger" id="approve_link">APPROVE</a>
                        <button type="button" class="btn btn-primary" data-dismiss="modal">cancel</button>
                    </div>
                </div>
            </div>

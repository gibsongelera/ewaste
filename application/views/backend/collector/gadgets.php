	...
	<!-- <div class="col-md-8"> -->
		<div class="col-md-12">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li class="active"><a href="#tab1" role="tab" data-toggle="tab"><i class="fa fa-users"></i> Disposable Garbage</a></li>
				<li><a href="#tab2" role="tab" data-toggle="tab"><i class="fa fa-plus"></i> Add New Disposable garbage</a></li>
			</ul>
			...
			<div class="tab-content tab-custom top-color-border">
					...
					<div class="row">
						<div class="col-xs-12 col-md-12">
					      <!-- <div class="with_border with_padding"> -->
					      	<h4>Registered disposable garbage (<?php echo $totalGadgets ?>)</h4>
				...
				<div class="tab-pane fade" id="tab2">
			      	<h4 class="divider_40">Add New Disposable Garbage</h4>
		                        	...
		                        	<td>
					  				...
					  				<td>
					  					<div class="form-group">
											<input type="text" name="gadgetName[]" autocomplete="off" class="form-control" placeholder="Garbage Type" id="gadgetName<?php echo $x; ?>">
					  					</div>
					  				</td>
					  				<td>
					  					<div class="form-group">
											<input type="number" name="gadgetPrice[]" autocomplete="off" class="form-control" min="1" placeholder="Quantity"id="gadgetPrice<?php echo $x; ?>">
					  					</div>		  					
					  				</td>
					  				<!-- <td>
					  					<div class="form-group">

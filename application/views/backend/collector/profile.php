...
<div class="row">
	...
	<!-- <div class="col-md-8"> -->
		<div class="col-md-7">
			...
			<?php
			$id = $this->session->userdata('id');
			$setting_id = $this->db->get_where('login', array('login_id' => $id));
			$profile = $this->db->get_where('profiles', array('login_id' => $id))->row();
			...
			<head>
				<title>Collector Profile :: E-WASTE</title>
				<?php include(APPPATH.'views/includes_top.php'); ?>
			</head>
			<body class="admin">
			<div class="preloader">
								...
								<div class="col-md-7">
									...
									<div class="tab-content tab-custom top-color-border">
										<div class="tab-pane fade in active" id="tab1">
											...
											echo form_open("collector/validate_profile/".$id, $attributes);?> 
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="number" class="form-control" placeholder="9XXXXXXXX" name="phone" value="<?php echo $phone ?>" id="phone">
												</div>
											</div>
											<div class="form-group">

							...
							<table class="table table-hover" id="example23">
								<thead>
									<tr>
										...
										<!-- <th>Payment</th> --> <!-- Payment column hidden -->
										<th>Stage</th>
										<th>Action</th>
									</tr>
								</thead>
										...
										<td>
											<div class="btn-group">
												<div class="dropdown">
													...
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="#" onclick="showPaidModal('<?php echo base_url();?>collector/disposes_crud/markPaid/<?php echo $transaction_code;?>')">
															<i class="fa fa-angle-double-right"></i> Mark Paid (Collector)
														</a>
													</li>
													-->
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="#" onclick="showApproveModal('<?php echo base_url();?>collector/disposes_crud/approve/<?php echo $transaction_code;?>')">
													...
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="#" onclick="showCollectModal('<?php echo base_url();?>collector/disposes_crud/markCollected/<?php echo $transaction_code;?>')">

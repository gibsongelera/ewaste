<div class="row">
          ...
          <?php $this->load->view('backend/admin/_client_pin_map_embed'); ?>
            ...
            <div class="col-xs-12 col-md-4">
              <div class="with_border with_padding">
                ...
                <br>
                  <div class="row">
                    <div col-sm-12>
                      <button class="btn btn-success" onclick="showLogsUrl('<?php echo base_url() ?>admin/logs')"> see all logs</button>
                    </div>
                  </div>
                <!-- .admin-scroll-panel -->
              </div>

...
class Client_model extends CI_Model {
	...
	public function get_all_client_locations() {
    $this->db->select('clients.name, clients.address, clients.latitude as lat, clients.longitude as lng, disposes.transaction_code');
    $this->db->from('clients');
    $this->db->join('disposes', 'clients.client_id = disposes.client_id', 'left');
    $this->db->where('clients.latitude IS NOT NULL');
    $this->db->where('clients.longitude IS NOT NULL');
